...
def scheme_eval(expr, env, tail=False): # Optional third argument is tail, which means whether the call is a tail-call
    ...
    if scheme_symbolp(first) and first in scheme_forms.SPECIAL_FORMS:
        ...
        return scheme_apply(first, argument, env)
        # END PROBLEM 3
...
def eval_all(expressions, env):
    ...
    return scheme_eval(expressions.first, env, True) #tail recursive
    # END PROBLEM 6
